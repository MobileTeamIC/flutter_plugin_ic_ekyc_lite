...
#ifndef EKYCLITE_SWIFT_H
#define EKYCLITE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="eKYCLite",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC8eKYCLite10CardConfig")
...
- (nonnull instancetype)initWithIsCheckAutoCardd:(BOOL)isCheckAutoCardd typee:(NSInteger)typee OBJC_DESIGNATED_INITIALIZER;
@end

@class UIImage;
enum MESSAGE_RESULT : NSInteger;
SWIFT_CLASS("_TtC8eKYCLite11CardWrapper")
...
SWIFT_CLASS("_TtC8eKYCLite12Face3DConfig")
...
@class NSString;
@class NSArray;
SWIFT_CLASS("_TtC8eKYCLite13Face3DWrapper")
